...
plot '../data/i_filt_time.dat' using 1:2 with lines lt 1 lw 2 lc rgb '#000088' notitle
...
set yrange [-2:300]                    # set y plot range
set xrange [0:511]                       # set x plot range
plot '../data/q_filt_time.dat' using 1:2 with lines lt 1 lw 2 lc rgb '#008800' notitle
...
set yrange [-2:300]                       # set y plot range
set xrange [0:511]                       # set x plot range
plot '../data/audio_filt_time.dat' using 1:2 with lines lt 1 lw 3 lc rgb '#880000' notitle
